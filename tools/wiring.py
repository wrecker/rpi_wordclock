...
class wiring:
    ...
    def __init__(self, config):
        ...
        elif wiring_layout == 'awakes_wiring':
            self.wcl = awakes_wiring(self.WCA_WIDTH, self.WCA_HEIGHT)
            self.LED_COUNT + self.WCA_HEIGHT * self.WCA_WIDTH + 5
        else:
...
class gtk_wiring:
    ...
    def __init__(self, WCA_WIDTH, WCA_HEIGHT):
        self.WCA_WIDTH = WCA_WIDTH
        self.WCA_HEIGHT = WCA_HEIGHT
        self.LED_COUNT = self.WCA_WIDTH * self.WCA_HEIGHT + 5
...
class awakes_wiring:
    ...
    def getStripIndexFrom2D(self, x, y):
        ...
        """
        if y % 2 == 0:
            pos = (self.WCA_WIDTH * y) + x
        else:
            pos = (self.WCA_WIDTH * y) + (self.WCA_WIDTH - x - 1)
        return self.LED_COUNT - pos - 1
