...
import plugins.time_default.time_german2 as time_german2
import plugins.time_default.time_dutch as time_dutch
import plugins.time_default.time_swabian as time_swabian
import plugins.time_default.time_swabian2 as time_swabian2
import plugins.time_default.time_bavarian as time_bavarian
import plugins.time_default.time_swiss_german as time_swiss_german
import plugins.time_default.time_swiss_german2 as time_swiss_german2
...
class wordclock_display:
    ...
    def __init__(self, config, wci):
        ...
        print("wcc.BLACK " + str(type(wcc.BLACK)))
        ...
        elif language == 'english15x14':
            self.taw = time_english15x14.time_english()
    ...
    def showIcon(self, plugin, iconName):
        ...
        """
        self.setImage(
            self.base_path + '/plugins/' + plugin + '/icons/' + self.dispRes() + '/' + iconName + '.png')
    ...
    def animate(self, plugin, animationName, fps=10, count=1, invert=False):
        ...
        """
        animation_dir = self.base_path + '/plugins/' + plugin + '/animations/' + self.dispRes() + '/' + animationName + '/'
